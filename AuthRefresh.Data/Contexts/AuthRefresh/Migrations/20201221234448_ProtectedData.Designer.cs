...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthRefresh.Data.Contexts.AuthRefresh.Models.ProtectedData", b =>
                {
                    b.Property<int>("ProtectedDataId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .UseIdentityColumn();
                    ...
                    b.HasKey("ProtectedDataId");

                    b.ToTable("ProtectedDatas");
                });
            ...
            modelBuilder.Entity("AuthRefresh.Data.Contexts.AuthRefresh.Models.UserProtectedData", b =>
                {
                    b.Property<int>("UserProtectedDataId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .UseIdentityColumn();
                    ...
                    b.HasKey("UserProtectedDataId");

                    b.HasIndex("ProtectedDataId");

                    b.HasIndex("UserId");

                    b.ToTable("UserProtectedDatas");
                });
            ...
            modelBuilder.Entity("AuthRefresh.Data.Contexts.AuthRefresh.Models.UserProtectedData", b =>
                {
                    b.HasOne("AuthRefresh.Data.Contexts.AuthRefresh.Models.ProtectedData", "ProtectedData")
                        .WithMany()
                        .HasForeignKey("ProtectedDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
